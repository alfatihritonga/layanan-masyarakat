            ...
            <div class="border-t pt-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    ...
                    <div class="relative group">
                        ...
                        @else
                        <a href="{{ $attachment->url }}" target="_blank" class="block aspect-square rounded-lg overflow-hidden bg-base-200 flex items-center justify-center hover:bg-base-300 transition">
